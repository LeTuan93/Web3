...
$listRegistrations = getRaw("SELECT * FROM registration WHERE user_id = $userId ORDER BY create_at");
...
<div id="registration_history" class="section" >
        ...
        <tbody>
            ...
            if (!empty($listRegistrations)):
                ...
                foreach ($listRegistrations as $item):
                    $count++;
                    // trong bảng registration có trường company_id, user_id 
            ...
            ?>
                    <tr>
                        ...
                        <!-- Nếu trạng thái chưa duyệt thì là màu đỏ còn đã duyệt là màu xanh dùng boostrap bình thường thôi -->
